...
#define INFO(format_str, ...) ::pm::Logger::get().message(::pm::ELogLevel::INFO, std::format(format_str __VA_OPT__(,) __VA_ARGS__), __FILE__, ##__FUNCTION__, __LINE__)
#define WARNING(format_str, ...) ::pm::Logger::get().message(::pm::ELogLevel::WARNING, std::format(format_str __VA_OPT__(,) __VA_ARGS__), __FILE__, ##__FUNCTION__, __LINE__)
#define ERROR(format_str, ...) ::pm::Logger::get().message(::pm::ELogLevel::ERROR, std::format(format_str __VA_OPT__(,) __VA_ARGS__), __FILE__, ##__FUNCTION__, __LINE__)
#define FATAL(format_str, ...) do { ::pm::Logger::get().message(::pm::ELogLevel::FATAL, std::format(format_str __VA_OPT__(,) __VA_ARGS__), __FILE__, ##__FUNCTION__, __LINE__); exit(EXIT_FAILURE); } while (0)
#endif
